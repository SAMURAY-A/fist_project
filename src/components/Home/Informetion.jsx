...
export default function Informetion() {
  return (
    <>
      <div className="contayner bg-red-500">
        <p>salom</p>
	...
	c21.2-8.1,52.2-18.2,79.7-24.2C399.3,7.9,411.6,7.5,421.9,6.5z"></path>
      ...
      <div>
        ...
        <img src="https://websitedemos.net/fashion-lifestyle-02/wp-content/uploads/sites/427/2019/01/clients01-free-img.jpg" alt="picture" />
      </div>
    </>
  );
}
